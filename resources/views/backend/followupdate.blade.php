...
<meta name="csrf-token" content="{{ csrf_token() }}" />
        <div class="main-content pt-4">
          ...
          <div class="row">
                    ...
                    <form class="rg_form" novalidate="novalidate" method="post" action="{{url('filter-followup')}}">
                        ...
                        <div class="row">
                          <div class="col-md-2 form-group mb-3">
                            ...
                            <input type="date" id="fromDate" name="fromdate" class="newdatepicker form-control" placeholder="dd/mm/yyyy" required>
                            <span class="fromdate_msg validation_err"></span>
                        </div>
                        <div class="col-md-2 form-group mb-3">
                            <label>To Date</label>
                            <input type="date" id="toDate" name="todate" class="newdatepicker form-control" placeholder="dd-mm-yyyy" required>
            ...
            <form class="" novalidate="novalidate" method="post" action="{{url('filter-followup')}}">
             {{ csrf_field() }}
            ...
            <div class="col-md-12 form-group mb-3">
                           ...
                           <button class="btn w-100 btn-outline-warning mb-2 " id="" style="background-color:#ffb400; color: black;"><?php $follow= count($todatfollowu);?>
                                  * Today Followup : <?php if(!empty($follow)){ echo count($todatfollowu);}else{ echo 0;}?>*
                            </button>                            
                              </div> 
