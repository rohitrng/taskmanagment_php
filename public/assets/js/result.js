...
function countresult(resultnumber) {
  ...
  if (correctprcnt < 50) {
    ...
    $(".result_msg").html(
      '<img src="http://localhost/kb/public/assets/images/cross.png" alt="cross"> You Failed!'
    );
    ...
    $(".result_msg").html(
      '<img src="http://localhost/kb/public/assets/images/warning.png" alt="warning"> Could have done better!'
    );
  } else if (correctprcnt >= 80) {
    ...
    $(".result_msg").html(
      '<img src="http://localhost/kb/public/assets/images/check.png" alt="check"> Wow! You are Brilliant!'
    );
  }
}
